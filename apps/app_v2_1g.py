...
def start_new_session():
    """Start a complete new session by clearing ALL session state"""
...
def main():
    ...
    with st.sidebar:
        ...
        if st.button("🔄 Neue Sitzung starten", help="Starte eine komplett neue Sitzung und setze alle Einstellungen zurück", type="primary"):
            start_new_session()
